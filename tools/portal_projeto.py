...
def regenerar_todos_portais_projeto() -> dict:
    ...
    template (ex: cor dos blocos de resumo), para essa alteração aparecer
    também nos portais já enviados às clientes, sem precisar de os gerar
    de novo um a um (pedido explícito do Rui, 2026-09-30)."""
    atualizados = 0
    erros = []
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .fecho{margin-top:8px;padding-top:16px;border-top:1px solid var(--line);text-align:center;
