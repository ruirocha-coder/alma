...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .doc{padding:14px 0 14px 26px;border-bottom:1px solid var(--line);font-size:14.5px;text-decoration:none;
  ...
  #orcamento .credito-bloco h3{font-size:14.5px;background-position:0 2px}
