...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .tile{position:relative;padding:14px 14px 14px;background:rgba(145,164,167,.15);border-radius:6px;
  ...
  .pf{padding:12px 18px;background:rgba(145,164,167,.15);border-radius:6px}
