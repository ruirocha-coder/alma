...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .nota{margin-top:30px;font-size:13px;color:var(--stone)}
  ...
  .painel-resumo{margin-top:18px;padding:2px 14px;background:rgba(145,164,167,.15)}
  .exemplo-selo{display:inline-block;font-size:12px;color:var(--clay);font-weight:500;letter-spacing:.01em}

  .pag-tit{margin-top:30px;font-size:15px;font-weight:500;color:var(--ink);padding-left:27px;
  ...
  .pf{padding:12px 18px;border-left:1px solid var(--line)}
  .pf:first-child{border-left:none;padding-left:0}
