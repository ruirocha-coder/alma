...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .tile{position:relative;padding:14px 14px 14px;background:rgba(164,58,35,.08);border-radius:6px;
  ...
  .tile:hover{background:rgba(164,58,35,.14)}
  ...
  .corpo{margin-top:0}
  .fase-topo+.corpo{margin-top:20px}
  ...
  .linhas{width:100%}
  .l{display:flex;justify-content:space-between;gap:20px;padding:10px 0;border-bottom:1px solid var(--line);font-size:15px}
  ...
  .hero-valor-label{color:var(--ink);font-size:11px;font-weight:500;
       text-transform:uppercase;letter-spacing:.05em}
  .hero-valor-numero{color:var(--ink);font-size:34px;font-weight:400;margin-top:6px}
  .hero-valor-nota{color:var(--ink);font-size:13px;font-weight:400;max-width:280px}
  ...
  .credito-bloco{margin-top:28px}
  .credito-bloco h3, .validar-texto h3{font-weight:400;font-size:14.5px;line-height:1.35;padding-left:27px;
  ...
  .pf{padding:12px 18px;background:rgba(164,58,35,.08);border-radius:6px}
  ...
  .fecho{margin-top:8px;padding-top:16px;border-top:1px solid var(--line);text-align:left;
       font-size:34px;font-weight:400;color:var(--ink);line-height:1.3}
